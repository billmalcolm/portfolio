...
function Skills() {
    return (
        <div className="skills">
            ...
            <p>
                Every time I think I've mastered a subject, I learn something new. Gaps in knowledge are not meant to be feared, but boldly explored.
            </p>

            <p>
                The following are technologies that I am always learning more about and trying to improve. They make the list when I complete a project and continue to use them.
            </p>
            <h3>Fundamentals</h3>
